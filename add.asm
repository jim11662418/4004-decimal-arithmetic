...
;-------------------------------------------------------------------------------
; Sixteen digit decimal addition demo.
; The first 16 digit integer is stored in RAM at 10H-1FH (least significant digit at 10H, most significant digit at 1FH)
; The second 16 digit integer is stored in RAM at 20H-2FH (least significant digit at 20H, most significant digit at 2FH)
; The 16 digit sum replaces the first integer at 10H-1FH (least significant digit at 10H, most significant digit at 1FH)
;--------------------------------------------------------------------------------
adddemo:    jms instruct
adddemo1:   jms newline             ; position carriage to beginning of next line
            jms newline
            fim P2,10H              
            ...
            fim P0,10H              ; P0 points to the first 16 digit number
            fim P1,20H              ; P1 points to the second 16 digit number to be added to the first
            jms ADDR                ; add the contents of the registers together, the sum goes into the first register
            src P0
            rd0
            jcn z,adddemo2
            jms overflow            ; non-zero means overflow
            jun adddemo1
adddemo2:   jms sum                 ; print "The sum is: "
...
;
; P0 points to first register, P1 points to second register. 
; Upon exit, P0 points to the sum. Status character 0 of the RAM register pointed to by P0 
; is set to 1 on overflow (the sum is greater than 16 digits).
;-------------------------------------------------------------------------------
ADRT        clc
ADDR        src P0
            rdm
...
txt1:       data CR,LF,LF
            ...
            data "press 'Enter'. The first integer is added to the second.",0
            
txt2:       data "First integer:  ",0
txt3:       data "Second integer: ",0
txt4:       data "Sum:            ",0
txt5:       data "Overflow!",0
